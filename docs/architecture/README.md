...
- [api-foundation.md](api-foundation.md) for the M1 schema, auth/session model, route skeleton, SSE, and secrets design
- [planning-workflow.md](planning-workflow.md) for the M2 readiness, setup, questionnaire, overview, and user-flow architecture
