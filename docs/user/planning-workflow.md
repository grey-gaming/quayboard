...
16. Open **UX Spec** and use the header action to generate the **UX Decision Tiles** once user flows are approved.
...
19. Generate or manually save the **UX Spec**, then run review, triage the review items, clear blocker items, and approve the current UX Spec.
...
21. Run review on the Technical Spec, triage the review items, clear blocker items, and approve the current Technical Spec.
