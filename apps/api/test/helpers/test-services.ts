...
export const createStubServices = (): AppServices => ({
  ...
  projectReviewService: {
    completeFixAttempt: async () => ({ sessionId: "00000000-0000-4000-8000-000000000099" }),
    completeReviewAttempt: async () => ({
      clear: false,
      findingCount: 1,
      sessionId: "00000000-0000-4000-8000-000000000099",
    }),
    failAttemptByJobId: async () => undefined,
    createAttempt: async () => ({
      id: "00000000-0000-4000-8000-000000000098",
      projectReviewSessionId: "00000000-0000-4000-8000-000000000099",
      projectId: "00000000-0000-4000-8000-000000000000",
    ...
    finalizeMilestonePlan: async () => ({
      ...
      userFlowsApprovalSnapshot: null,
      milestoneMapGeneratedAt: null,
      milestoneMapReviewStatus: "not_started" as const,
      milestoneMapReviewIssues: [],
      milestoneMapReviewedAt: null,
      milestoneMapReviewLastJobId: null,
      milestonePlanStatus: "finalized" as const,
    ...
    getLatestSessionDetail: async () => ({ session: null }),
    getPhase: async () => ({
      finalized: false,
      latestStatus: null,
    ...
    getSessionById: async () => ({ session: null }),
    listSessions: async () => [],
    ...
    markProjectCompleted: async () => ({
      ...
      milestonePlanStatus: "finalized" as const,
      milestonePlanFinalizedAt: new Date().toISOString(),
      ownerUserId: "00000000-0000-4000-8000-000000000001",
      createdAt: new Date().toISOString(),
      updatedAt: new Date().toISOString(),
    }),
    reopenMilestonePlan: async () => ({
      id: "00000000-0000-4000-8000-000000000000",
      ownerUserId: "00000000-0000-4000-8000-000000000001",
      name: "Stub Project",
      description: null,
    ...
    retryFixes: async () => ({ session: null }),
    startReview: async () => ({ session: null }),
    assertOwnedProject: async () => ({
      id: "00000000-0000-4000-8000-000000000000",
      ownerUserId: "00000000-0000-4000-8000-000000000001",
      name: "Stub Project",
  ...
  sandboxService: {
    ...
    getLatestProjectReviewArtifacts: async () => ({
    ...
    resolveProjectReviewBranchPlan: async () => ({
      baseBranchName: "main",
      cloneBranchName: "main",
      targetBranchName: "quayboard/project-review-fixes",
      pullRequestTitle: "Project review remediation",
      pullRequestBody: "Stub project review remediation branch plan.",
    }),
