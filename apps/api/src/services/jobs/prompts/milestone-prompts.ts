...
const buildMilestoneDesignContractInstructions = (input: { hasLinkedUserFlows: boolean }) => [
  ...
  "Do include the minimum technical mechanics, provider boundaries, data sources, artifacts, or integrations required to make in-scope user behavior real.",
  ...
  "Each exit criterion must make clear whether it is real production behavior, a test-double/mock boundary, or visibly not implemented. Do not let placeholder mechanics satisfy a production behavior criterion.",
...
export const buildMilestoneFeatureSetPrompt = (input: {
  ...
  [
    ...
    "Do not include acceptance criteria that depend on behavior the milestone design document marks out of scope.",
    "Do include the minimum technical mechanics, provider boundaries, data sources, artifacts, or integrations required to make in-scope user behavior real.",
    "Do not satisfy exit criteria with placeholder mechanics, fake generated content, empty artifact references, or silent production stubs.",
    "Reject feature boundaries that claim a user-facing capability while omitting the generation, provider, persistence, artifact, or integration boundary that makes it true.",
...
export const buildMilestoneFeatureSetReviewPrompt = (input: {
  ...
  [
    ...
    "Remove or rewrite any acceptance criterion that depends on out-of-scope behavior or future-milestone behavior.",
    "Restore missing mechanics, provider boundaries, data sources, artifacts, or integrations when they are required for an in-scope capability to be real.",
    "Reject feature sets that claim a user-facing capability while omitting the generation, provider, persistence, artifact, or integration boundary that makes it true.",
    "Reject placeholder mechanics, fake generated content, empty artifact references, or silent production stubs as satisfaction of production behavior.",
