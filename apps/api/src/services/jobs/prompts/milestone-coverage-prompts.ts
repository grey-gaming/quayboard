...
export const buildRewriteMilestoneFeatureSetPrompt = (input: {
  ...
  [
    ...
    "Do not include rewritten acceptance criteria that depend on behavior listed as out of scope in the milestone design document.",
    ...
    "Do not resolve a coverage gap by replacing a core capability with placeholder mechanics, fake generated content, empty artifact references, or silent production stubs.",
