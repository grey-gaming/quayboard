...
export const buildMilestoneDesignRisksPrompt = (input: {
  ...
  [
    ...
    "Treat the validated milestone design draft as the resolved source of truth. Do not re-open contradictions that the validated design already settled.",
    "Do not describe alternate interpretations that conflict with the validated design's in-scope responsibilities, transitions, or exit criteria.",
    "Do not invent future-milestone scope.",
    "Do not wrap the JSON in code fences.",
    "",
    "Example JSON fragment:",
